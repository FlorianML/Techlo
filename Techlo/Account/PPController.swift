...
class PPController: UIViewController {
    ...
    let privacyTextView: UITextView = {
        ...
        textView.backgroundColor = ColorModel.returnNavyDark()
        textView.textContainer.lineBreakMode = .byWordWrapping
        
        let attributedText = NSMutableAttributedString(string: "Privacy Policy \n\n", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 18, weight: .bold), NSAttributedString.Key.foregroundColor : UIColor.flatWhiteColorDark()])
        ...
        Conditions.
        """, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14, weight: .light), NSAttributedString.Key.foregroundColor : UIColor.flatWhiteColorDark()]))
        
        attributedText.append(NSAttributedString(string: """
        \n\nInformation Collection And Use\n\n
        """, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16, weight: .bold), NSAttributedString.Key.foregroundColor : UIColor.flatWhiteColorDark()]))
        ...
        attributedText.append(NSAttributedString(string: """
        \n\nPersonal Data\n\n
        """, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15, weight: .bold), NSAttributedString.Key.foregroundColor : UIColor.flatWhiteColorDark()]))
        ...
        attributedText.append(NSAttributedString(string: """
        Techlo uses the collected data for various purposes:
        ...
        Techlo will take all steps reasonably necessary to ensure that your data is treated securely
        ...
        attributedText.append(NSAttributedString(string: """
        Techlo may disclose your Personal Data in the good faith belief that such action is necessary
        to:
        To comply with a legal obligation
        To protect and defend the rights or property of Techlo
    ...
    func setupViews(){
        ...
        if #available(iOS 11.0, *) {
            privacyTextView.anchor(view.safeAreaLayoutGuide.topAnchor, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 0)
        } else {
            // Fallback on earlier versions
            privacyTextView.anchor(view.layoutMarginsGuide.topAnchor, left: view.leftAnchor, bottom: view.layoutMarginsGuide.bottomAnchor, right: view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 0)
